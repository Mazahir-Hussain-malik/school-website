...
const SeniorsHero = () => {
  ...
  return (
    <header className=" relative  header_hero_section_juniors  mt-[5rem] flex flex-col justify-center items-center h-[80vh]   ">
      <div className=" max-w-[1300px] mx-auto flex flex-col justify-center items-center  gap-6    ">
        <h1 className=" text-center md:w-[60%] md:text-[50px] sm:text-2xl font-bold ">
                Our senior Department
        </h1>
